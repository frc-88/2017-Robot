 ...
 * Shooter
 * 
 * look what we have here a tank that is full of fuel we should make it rain
 * 
 */
public class Shooter extends Subsystem {
	...
	public void updateDashboard() {
		...
		// SmartDashboard.putNumber("ShooterSpeed", flywheelTalon.getSpeed() +
		// ":" + feederTalon.getSpeed());
	}
